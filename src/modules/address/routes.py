...
@addressRouter.get('/{id}', summary="Get Address", description="Get an address", response_model=Response[Address],
...
@addressRouter.delete('/{id}', summary="Delete Address", description="Delete an address", response_model=Response,
...
@addressRouter.put('/{id}', summary="Edit Address", description="Edit an address", response_model=Response[Address],
responses={ 400: generate400ResContent(), 404: generate404ResContent("Address"), 422: {} })
